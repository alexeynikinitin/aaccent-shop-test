  ...
  return (
    <div className="pages">
      {paginatorNumber > 1 && (
        ...
        <img className="pageArrow" alt="prev" src="/icons/arrow-left.png" onClick={onClickPrev} />
      )}
      {massPages
      ...
      {paginatorNumber < paginatorCount - 1 && (
        // eslint-disable-next-line jsx-a11y/click-events-have-key-events,jsx-a11y/no-noninteractive-element-interactions
        <img className="pageArrow" alt="next" src="/icons/arrow-right.png" onClick={onClickNext} />
      )}
